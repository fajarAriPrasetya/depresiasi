      ...
      <div class="header">
        <div class="header_isi">
          ...
          <form action="home.php" method="POST">
			<br/>
              <p><center class="center"><h1><font color="white">Login</font></h1></center></p>
			  <br/>
              ...
              <br/>
              <center><div class="chexbox"></center>
              <center><input type="checkbox" name="chek" ><font color="white"> Remember me </font><br /></center>
              <br/>
            </div>
