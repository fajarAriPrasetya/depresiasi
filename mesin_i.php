...
<html>
    ...
    <body>
        <form method="POST" action="mesin_p.php">
            ...
            <center><p><h3><font color="white">Masukan Mesin Jahit</font color></h3></p></center>
            </br>
            <table align="center">
                <tr>
                <center><font color="white">Merk Mesin Jahit: <select name="id_merk"></font color>
											<?php
												include "kon.php";
                ...
                <tr>
                <td colspan="2"><center><font color="white">Tanggal Perolehan</td><td>
                ...
                <tr>
                <td colspan="2"><center><font color="white">Harga Perolehan</td><td>
